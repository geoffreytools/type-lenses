...
`type-lenses` re-exports a [dozen](https://github.com/geoffreytools/free-types/blob/master/Documentation.md#free) built-in free type constructors under the namespace `free`.
